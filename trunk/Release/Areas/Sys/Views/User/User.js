                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (type === "display") {
                        ...
                        if (row.IsActive) {
                            ...
                            html += _renderButton(true,
                                "EditUser",
                                "btn btn-lighter-success mr-1 dropdown-item",
                                "/Sys/User/Edit/" + data,
                                '<i class="fa fa-edit text-success text-120"></i> Cập nhật',
                                "Cập nhật", 1024);
                            ...
                            html += _renderButton(true,
                                ...
                                '<i class="fas fa-tasks text-info text-120"></i> Phân quyền báo cáo',
                                "Phân quyền báo cáo");
                            ...
                            html += _renderButton(true,
                                ...
                                '<i class="fas fa-user-shield text-warning text-120"></i> Quyền',
                                "Quyền");
                            ...
                            html += _renderButton(true,
                                ...
                                '<i class="fa fa-key text-primary text-120"></i> Đổi mật khẩu',
                                "Đổi mật khẩu");

                            html += _renderButton(true,
                                "DeActiveUser",
                                "btn btn-lighter-default mr-1 dropdown-item",
                                "/Sys/User/DeActive/" + data,
                                '<i class="fas fa-user-lock text-default text-120"></i> Ngưng hoạt động',
                                "Ngưng hoạt động");

                            html += _renderButton(true,
                                "ResetPassword",
                                "btn btn-lighter-purple mr-1 dropdown-item",
                                "/Sys/User/ResetPassword/" + data,
                                '<i class="fa fa-paper-plane text-purple text-120"></i> Reset mật khẩu',
                                "Reset mật khẩu");  
                            ...
                            html += _renderButton(true,
                                ...
                                '<i class="fa fa-id-card text-primary text-120"></i> Tài khoản hóa đơn điện tử',
                            ...
                            if (row.Processing == 0) {
                                ...
                                html += _renderButton(true,
                                    ...
                                    '<i class="fa fa-trash text-danger text-120"></i> Xóa',
                                    "Xóa");
                            }
                        }
                        else {
                            ...
                            html += _renderButton(true,
                                ...
                                '<i class="fa fa-check-square text-primary text-120"></i>',
                                "Kích hoạt");
                            if (row.Processing == 0) {
