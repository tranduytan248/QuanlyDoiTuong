...
namespace TSFramework.Core.Members.Encode
{
    public class RsaEncryptor
    {
        ...
        private static readonly bool optimalAsymmetricEncryptionPadding = false;
        ...
        public static string Encrypt(string plainText)
        {
            ...
            GetKeyFromEncryptionString(PUBLIC_KEY, out keySize, out publicKeyXml);
        ...
        {
            if (optimalAsymmetricEncryptionPadding) return (keySize - 384) / 8 + 7;
