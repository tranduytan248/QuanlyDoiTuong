...
namespace TSFramework.Core.Helpers
{
    public static class ConvertDateHelper
    {
        ...
        public static int getLunarMonth11(int yy, double timeZone)
        {
            ...
            var sunLong = INT(getSunLongitude(nm, timeZone) / 30);
        ...
        public static int[] convertSolar2Lunar(int dd, int mm, int yy, double timeZone)
        {
            ...
            return new[] { lunarDay, lunarMonth, lunarYear, lunarLeap };
        }
            ...
            double timeZone)
        {
            ...
            if (b11 - a11 > 365)
            {
                ...
                if (lunarLeap != 0 && lunarMonth != leapMonth) return new[] { 0, 0, 0 };
        ...
        public static bool IsLeapLunarYear(int lunarYear)
        {
            // Các năm nhuận theo quy tắc 19 năm một lần
            int[] leapYears = { 3, 6, 9, 11, 14, 17, 0 };

            var leapYear = lunarYear % 19;
            return Array.IndexOf(leapYears, leapYear) >= 0;
        }
    }
}