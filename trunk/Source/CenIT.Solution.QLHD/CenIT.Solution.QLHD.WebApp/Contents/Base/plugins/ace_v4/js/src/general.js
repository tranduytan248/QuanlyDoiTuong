...
class Basic {
    ...
    */
    static _handleAlerts () {
        ...
        $(document)
            .on("close.bs.alert.alert-collapse",
                ".alert.alert-collapse",
                function(e) {
                    e.preventDefault();
                    $(this).wrap('<div class="collapse show alert-collapse"></div>').parent().collapse("hide").one(
            ...
            .on("show.bs.collapse",
                ...
                function(ev) {
                    ...
                    if (previousOpenCollapse !== null) {
                        $(".navbar-collapse.show").css("transition-duration", "1ms").collapse("hide")
