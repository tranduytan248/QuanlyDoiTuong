    ...
    fileTree
        .tree({
            ...
            onCanMoveTo: function(node) {
                node.element.querySelector("* > .jqtree-element").classList
                    .add("bgc-warning-l1", "border-x-2", "brc-warning");
                return true;
            },
            ...
            onCreateLi: function(node, $li) {
                ...
                if (node.icons) {
                    ...
                    if (node.icons.open) {
                        ...
                        $title.prepend(
                            $(node.icons.open[0]).addClass(node.icons.open[1]).addClass("opened-icon")
                            .addClass("node-icon")
                        );
                    }
                }
    ...
    fileTree
        ...
        .on("tree.contextmenu",
            ...
            <div class="dropdown-menu dropdown-caret radius-1 border-b-2 shadow-sm brc-default-m2 dd-slide-up dd-slide-none-md"><div class="dropdown-inner">\
                <div class="d-md-none dropdown-title px-3 text-secondary-d3">' +
                        event.node.name +
                        '</div>\
