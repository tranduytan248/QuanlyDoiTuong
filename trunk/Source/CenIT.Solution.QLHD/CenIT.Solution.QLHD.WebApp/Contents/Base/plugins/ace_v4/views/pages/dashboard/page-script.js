jQuery(function($) {
    ...
    $("#tasks input[type=checkbox]").on("change",
        function() {
            $(this).closest("#tasks > div").toggleClass("bgc-secondary-l4", this.checked).find("label")
    ...
    // place the legends
    $(trafficSourceCanvas)
        .parent().after("<div id='traffic-source-legends' class='piechart-legends text-95 text-secondary-d3'>" +
