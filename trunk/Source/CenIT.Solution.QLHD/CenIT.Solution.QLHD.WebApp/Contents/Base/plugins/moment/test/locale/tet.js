...
test("parse",
    function(assert) {
        var tests =
                "Janeiru Jan_Fevereiru Fev_Marsu Mar_Abril Abr_Maiu Mai_Juniu Jun_Juliu Jul_Augustu Aug_Setembru Set_Outubru Out_Novembru Nov_Dezembru Dez"
                    .split("_"),
            i;
...
test("format week",
    function(assert) {
        var expected =
                "Domingu Dom Do_Segunda Seg Seg_Tersa Ters Te_Kuarta Kua Ku_Kinta Kint Ki_Sexta Sext Sex_Sabadu Sab Sa"
                    .split("_"),
            i;
        for (i = 0; i < expected.length; i++) {
