$(function() {
    ...
    QUnit.test("shoud hide/collapse card",
        function(assert) {
            assert.expect(2);
            var done = assert.async();

            var card = $('<div class="card"><div class="card-header"></div><div class="card-body"></div></div>')
                .appendTo("#qunit-fixture");
            card.get(0).addEventListener("hidden.ace.card",
                function() {
    ...
    QUnit.test("shoud hide/collapse card fast",
        function(assert) {
            assert.expect(1);
            var done = assert.async();
    ...
    QUnit.test("shoud show card",
        function(assert) {
            assert.expect(2);
            var done = assert.async();

            var card = $(
                    '<div class="card"><div class="card-header"></div><div class="card-body collapse"></div></div>')
                .appendTo("#qunit-fixture");
            card.get(0).addEventListener("shown.ace.card",
                function() {
    ...
    QUnit.test("shoud show card fast",
        function(assert) {
            assert.expect(1);
            var done = assert.async();
    ...
    QUnit.test("shoud close/remove card",
        function(assert) {
            assert.expect(2);
            var done = assert.async();

            var card = $('<div class="card"></div>').appendTo("#qunit-fixture");
            card.get(0).addEventListener("closed.ace.card",
                function() {
                    setTimeout(function() {
    ...
    QUnit.test("shoud close/remove card fast",
        function(assert) {
            assert.expect(2);
            var done = assert.async();
    ...
    QUnit.test("shoud expand/restore card",
        function(assert) {
            assert.expect(7);
            var done = assert.async();

            var card = $('<div class="card"></div>').appendTo("#qunit-fixture");
            card.get(0).addEventListener("expanded.ace.card",
                function() {
            ...
            card.get(0).addEventListener("restored.ace.card",
                function() {
    ...
    QUnit.test("shoud expand card fast",
        function(assert) {
            assert.expect(1);
            var done = assert.async();
    ...
    QUnit.test("shoud remove placeholder of an expanded card",
        function(assert) {
            assert.expect(3);
            var done = assert.async();

            var card = $('<div class="card"></div>').appendTo("#qunit-fixture");
            AceApp.EventHandler.one(card.get(0),
                "expanded.ace.card",
                function() {
                    card.aceCardNC("close");
                });
    ...
    QUnit.test("shoud add/remove loading overlay",
        function(assert) {
            assert.expect(2);

            var card = $('<div class="card"></div>').appendTo("#qunit-fixture");

            card.aceCardNC("startLoading",
                '<i class="bs-card-loading-icon fa fa-spinner fa-spin fa-2x text-white">LOADING</i>');
    ...
    QUnit.test("shoud prevent collapsing/showing/closing/expanding/restoring card",
        function(assert) {
            assert.expect(3);

            var card = $('<div class="card"><div class="card-header"></div><div class="card-body"></div></div>')
                .appendTo("#qunit-fixture");
            card.get(0).addEventListener("hide.ace.card",
                (ev) => {
                    ev.preventDefault();
                });

            card.get(0).addEventListener("expand.ace.card",
                (ev) => {
                    ev.preventDefault();
                });

            card.get(0).addEventListener("close.ace.card",
                (ev) => {
                    ev.preventDefault();
                });
    ...
    QUnit.test("should return card version",
        function(assert) {
            assert.expect(1);
