...
namespace Reports._01.BaoCaoChiTietHopDongCongNo
{
    [ReportInfo("_01BaoCaoChiTietHopDongCongNo", "01 - Báo cáo chi tiết hợp đồng - Công nợ",
        "01 - Báo cáo chi tiết hợp đồng - Công nợ")]
    public class _01BaoCaoChiTietHopDongCongNo : IReport
    {
        private string TemplateReport => "_01BaoCaoChiTietHopDongCongNo.rdlc";
        private object[] ReportParams { get; set; }
        private string DataSetName => "BaoCaoChiTietHopDongCongNo01";
        public string ReportKey => "_01BaoCaoChiTietHopDongCongNo";
        public string ReportName => "01 - Báo cáo chi tiết hợp đồng - Công nợ";
        public string Description => "01 - Báo cáo chi tiết hợp đồng - Công nợ";
        public string ProcedureName => "p_Reports_01BaoCaoChiTietHopDongCongNo";
        public string ViewName => "_01BaoCaoChiTietHopDongCongNo";
        ...
        public void Export(HttpResponseBase response, DataTable data, string urlPathReport)
        {
            ...
            //Chuyển sang Excel
            var bytes = reportExcel.LocalReport.Render("EXCEL", null, out _, out _, out var extension,
                out _, out _);
