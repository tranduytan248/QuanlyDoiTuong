...
test("parse zone without a timezone",
    function(assert) {
        ...
        var m3 = moment.parseZone(
            "2016-02-01T00:00:00+00:00"); //Someone might argue this is not necessary, you could even argue that is wrong being here.
        var m4 = moment.parseZone(
            "2016-02-01T00:00:00+0000"); //Someone might argue this is not necessary, you could even argue that is wrong being here.
        assert.equal(
...
test("parse zone with weekday on verifies day acccording to the offset",
    function(assert) {
        test.expectedDeprecations();
