$(function() {
    ...
    QUnit.test("should trigger sticky event",
        function(assert) {
            assert.expect(1);
            ...
            setTimeout(function() {
                    nav.get(0).addEventListener("sticky-change",
                        function(e) {
    ...
    QUnit.test("should not trigger sticky event on above `md` size",
        function(assert) {
            assert.expect(1);
            var done = assert.async();
    ...
    QUnit.test("should trigger sticky event on below `md` size",
        function(assert) {
            assert.expect(1);
            var done = assert.async();
