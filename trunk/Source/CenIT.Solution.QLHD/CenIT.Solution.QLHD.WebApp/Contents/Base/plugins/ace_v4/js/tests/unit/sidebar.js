$(function() {
    ...
    QUnit.test("should be defined on jquery object",
        function(assert) {
            assert.expect(1);
    ...
    QUnit.test("should provide no conflict",
        function(assert) {
            assert.expect(1);
            assert.strictEqual(typeof $.fn.aceSidebar, "undefined", "sidebar was set back to undefined (org value)");
        });

    QUnit.test("should return jquery collection containing the element",
        function(assert) {
            assert.expect(2);
            var $el = $("<div />");
    ...
    QUnit.test("should return jquery collection containing the element",
        function(assert) {
            ...
            $('<button type="button" data-toggle-mobile="sidebar" data-target="#sidebar2"></button>')
                .appendTo("#qunit-fixture");
            $('<button type="button" data-toggle="sidebar" data-target="#sidebar2"></button>')
                .appendTo("#qunit-fixture");
    ...
    QUnit.test(
        "should disable body scrollbars when sidebar is being swiped and hide sidebar when swiped more than 40px",
        function(assert) {
            ...
            var sidebar =
                $(
                        '<div id="sidebar" class="sidebar" data-swipe="true"><div class="sidebar-inner"><div class="ace-scroll"></div></div></div>')
                    .appendTo("#qunit-fixture");
            sidebar.aceSidebarNC("show");

            sidebar.get(0).addEventListener("shown.ace.sidebar",
                function() {
    ...
    QUnit.test("`data-dismiss=true` should hide sidebar when clicked outside of sidebar area",
        function(assert) {
            viewport.set(320, 480);
            ...
            var sidebar =
                $(
                        '<div id="sidebar" class="sidebar" data-dismiss="true"><div class="sidebar-inner"><div class="ace-scroll"></div></div></div>')
                    .appendTo("#qunit-fixture");
    ...
    QUnit.test("should expand/collapse sidebar",
        function(assert) {
            ...
            var btn = $('<button type="button" data-toggle="sidebar" data-target="#sidebar3"></button>')
                .appendTo("#qunit-fixture");
            var sidebar =
                $(
                        '<div id="sidebar3" class="sidebar"><div class="sidebar-inner"><div class="ace-scroll"></div></div></div>')
                    .appendTo("#qunit-fixture");
            ...
            sidebar.get(0).addEventListener("collapsed.ace.sidebar",
                function() {
    ...
    QUnit.test("should show/hide sidebar",
        function(assert) {
            viewport.set(320, 480);
            assert.expect(2);
            var done = assert.async();

            var btn = $('<button type="button" data-toggle-mobile="sidebar" data-target="#sidebar4"></button>')
                .appendTo("#qunit-fixture");
            var sidebar =
                $(
                        '<div id="sidebar4" class="sidebar"><div class="sidebar-inner"><div class="ace-scroll"></div></div></div>')
                    .appendTo("#qunit-fixture");
            sidebar.aceSidebarNC();
    ...
    QUnit.test("should prevent expanding/collapsing sidebar",
        function(assert) {
            assert.expect(1);
            viewport.set(1320, 1480);
            ...
            sidebar.aceSidebarNC().get(0).addEventListener("collapse.ace.sidebar",
                function(e) {
                    e.preventDefault();
                    viewport.reset();
                });
    ...
    QUnit.test("should prevent hiding/showing sidebar",
        function(assert) {
            assert.expect(1);
            viewport.set(320, 480);
            ...
            sidebar.aceSidebarNC().get(0).addEventListener("show.ace.sidebar",
                function(e) {
                    e.preventDefault();
                });
    ...
    QUnit.test("should return sidebar version",
        function(assert) {
            assert.expect(1);
