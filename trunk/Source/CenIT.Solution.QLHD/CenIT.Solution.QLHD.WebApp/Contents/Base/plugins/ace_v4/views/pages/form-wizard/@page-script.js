jQuery(function($) {
    ...
    $("#smartwizard-1").smartWizard({
        ...
        .on("showStep",
            function(e, anchorObject, stepNumber, stepDirection) {
                ...
                progress -=
                    halfStepWidth; //because for example for the first step, we don't want progressbar to move all the way to next step
    ...
    $("#wizard-1-prev").on("click",
        function() {
            $("#smartwizard-1").smartWizard("prev");
        });

    $("#wizard-1-next").on("click",
        function() {
            $("#smartwizard-1").smartWizard("next");
        });

    $("#wizard-1-finish").on("click",
        function() {
            //
        });
    ...
    $("#validation-form").validate({
        ...
        success: function(error, element) {
            ...
            parent.append(
                '<span class="form-text d-inline-block ml-sm-2"><i class=" fa fa-check text-success-m1 text-120"></i></span>');
        },
