jQuery(function($) {
    ...
    $("#id-material")
        .on("click",
            function() {
                var icons = [
                    "home", "dashboard", "computer", "border_all", "edit", "dashboard", "calendar_today", "camera",
                    "apps"
                ];
                $(".sidebar")
    ...
    $("#id-jamicons")
        .on("click",
            function() {
                var icons = [
                    "dashboard", "layout", "computer-alt", "grid", "pencil", "task-list", "calendar", "picture", "tag"
                ];
                $(".sidebar")
                    .find(".nav > .nav-item > .nav-link > .nav-icon")
                    .each(function(index, e) {
    ...
    $("#id-evaicons")
        .on("click",
            function() {
                var icons = [
                    "home-outline", "layout-outline", "monitor-outline", "grid-outline", "edit-2-outline",
                    "browser-outline", "calendar-outline", "image-outline", "cube-outline"
                ];
                $(".sidebar")
                    .find(".nav > .nav-item > .nav-link > .nav-icon")
                    .each(function(index, e) {
                        $(this)
                            .after('<i class="nav-icon eva eva-' + icons[index] + '"></i>').remove();
                    });
    ...
    $("#id-fontawesome")
        .on("click",
            function() {
                var icons = [
                    "fa fa-tachometer-alt", "fa fa-cube", "fa fa-desktop", "fa fa-table", "fa fa-edit", "fa fa-list",
                    "far fa-calendar-alt", "far fa-image", "fa fa-tag"
                ];
                $(".sidebar")
                    .find(".nav > .nav-item > .nav-link > .nav-icon")
                    .each(function(index, e) {
