        ...
        .on("change",
            function() {
                ...
                if (this.value == "white") {
                    $(".feature-item")
                        .addClass(
                            "border-1 brc-dark-l3"); // in white theme, add a border to feature items (speed, flexibility, etc)

                    $("#page-intro-light")
                        .addClass(
                            "bgc-white border-0 border-b-1 brc-dark-l3 border-dotted"); // add a dotted border below intro
