...
test("is same or before minute",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 9, 10)), "minutes"),
            true,
            "plural should work");
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 59, 999)), "minute"),
            true,
            "exact end of minute");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 5, 0, 0)), "minute"),
            true,
...
test("is same or before second",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 5, 10)), "seconds"),
            true,
            "plural should work");
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 5, 999)), "second"),
            true,
            "exact end of second");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 6, 0)), "second"),
            true,
...
test("is same or before millisecond",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), "millisecond"),
            false,
            "year is earlier");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 4, 2, 3, 4, 5, 10)), "millisecond"),
            true,
            "month is later");
...
test("is same with utc offset moments",
    function(assert) {
        assert.ok(moment.parseZone("2013-02-01T00:00:00-05:00").isSameOrBefore(moment("2013-02-01"), "year"),
        ...
        assert.ok(
            moment.parseZone("2013-02-01T00:00:00-05:00")
            .isSameOrBefore(moment.parseZone("2013-02-01T00:00:00-06:30"), "year"),
