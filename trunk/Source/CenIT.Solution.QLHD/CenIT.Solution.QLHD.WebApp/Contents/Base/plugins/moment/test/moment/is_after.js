...
test("is after year",
    function(assert) {
        ...
        assert.equal(m.isAfter(moment(new Date(1980, 11, 31, 23, 59, 59, 999)), "year"),
            true,
...
test("is after millisecond",
    function(assert) {
        ...
        assert.equal(m.isAfter(moment(new Date(2011, 3, 2, 3, 4, 6, 11)), "millisecond"),
            false,
            "millisecond is later");
        assert.equal(m.isAfter(moment(new Date(2011, 3, 2, 3, 4, 4, 9)), "millisecond"),
            true,
