    ...
    $("#id-toast-dark").on("click",
        function() {
            $.aceToaster.add({
                ...
                body:
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. <a href='#' class='text-warning-m3'>Vivamus eget</a> tincidunt velit.\
    ...
    $("#id-toast-primary").on("click",
        function() {
            ...
            ',
                ...
                closeClass:
                    "btn btn-xs py-0 btn-link bgc-h-white-tp9 no-underline text-white text-150 position-tr mr-n2",
