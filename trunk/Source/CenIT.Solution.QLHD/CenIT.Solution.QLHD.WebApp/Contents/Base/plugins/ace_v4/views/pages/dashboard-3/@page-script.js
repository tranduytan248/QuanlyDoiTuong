jQuery(function($) {
    ...
    $(".page-tools .btn").tooltip({
        container: "body",
        template:
            '<div class="tooltip" role="tooltip"><div class="arrow brc-secondary-d2"></div><div class="tooltip-inner text-600 text-110 pb-2 bgc-secondary-d2"></div></div>',
        trigger: "hover",
        placement: "top"
    });
                    ...
                    custom: function(tooltipModel) {
                        ...
                        $(canvas)
                            .tooltip({
                                placement: "bottom",
                                template:
                                    '<div class="tooltip" role="tooltip"><div class="bgc-info-d2 tooltip-inner font-bolder text-110"></div></div>'
                            })
                            .tooltip("show")
