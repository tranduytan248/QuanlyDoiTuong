...
namespace TSFramework.Core.Utils
{
    public static class EString
    {
        ...
        public static string GenerateStrongPassword(int length)
        {
            ...
            var pLower = GetRandomPosition(ref posArray, r);
            var pUpper = GetRandomPosition(ref posArray, r);
            var pNumber = GetRandomPosition(ref posArray, r);
            var pSpecial = GetRandomPosition(ref posArray, r);
        ...
        public static string Format(this string source, Dictionary<string, object> parameters)
        {
            return parameters.Aggregate(source,
