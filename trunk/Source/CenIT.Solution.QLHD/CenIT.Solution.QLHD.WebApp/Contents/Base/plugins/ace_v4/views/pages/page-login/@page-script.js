        ...
        .on("click",
            function(e) {
                ...
                $(".main-content").removeClass("justify-content-center minh-100").addClass("px-4 px-lg-0")
                    .children()
                    .attr("class",
                        "d-flex flex-column flex-lg-row flex-grow-1 my-3 m-lg-0"); // removes padding classes and add d-flex, etc

                $("#row-1")
                    .addClass("flex-grow-1")
                    .find("> .col-12").removeClass("shadow radius-1 col-xl-10 offset-xl-1")
                ...
                $("#id-col-main").removeClass("col-lg-7 offset-2")
                    .addClass("col-lg-6 mx-auto d-flex align-items-center justify-content-center");
            });
