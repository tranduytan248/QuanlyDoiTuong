namespace TSFramework.Core.Helpers
{
    ...
    public class LunarSolarDateHelper
    {
        public static readonly int[] LunarMonthDays =
        {
            1887, 0x1694, 0x16aa, 0x4ad5, 0xab6, 0xc4b7, 0x4ae, 0xa56, 0xb52a,
            0x1d2a, 0xd54, 0x75aa, 0x156a, 0x1096d, 0x95c, 0x14ae, 0xaa4d, 0x1a4c, 0x1b2a, 0x8d55, 0xad4, 0x135a,
            0x495d,
            ...
            0xf55b, 0x4ba, 0x125a, 0xb92b, 0x152a, 0x1694, 0x96aa, 0x15aa, 0x12ab5, 0x974, 0x14b6, 0xca57, 0xa56,
            0x1526,
        ...
        public static readonly int[] Solar11 =
        {
            ...
            0x103053,
            0x103247, 0x10343b, 0x10364f, 0x103845, 0x103a38, 0x103c4c, 0x103e42, 0x104036, 0x104249, 0x10443d,
            0x104651,
            0x104846, 0x104a3a, 0x104c4e, 0x104e43, 0x105038, 0x10524a, 0x10543e, 0x105652, 0x105847, 0x105a3b,
            0x105c4f,
            0x105e45, 0x106039, 0x10624c, 0x106441, 0x106635, 0x106849, 0x106a3d, 0x106c51, 0x106e47, 0x10703c,
            0x10724f,
        ...
        public static Solar LunarToSolar(Lunar lunar)
        {
            ...
            for (var i = 0; i < loopend; i++) offset += GetBitInt(days, 1, 12 - i) == 1 ? 30 : 29;
            offset += lunar.LunarDay;

            var solar11 = Solar11[lunar.LunarYear - Solar11[0]];
        ...
        {
            var lunar = new Lunar();
            var index = solar.SolarYear - Solar11[0];
            var data = (solar.SolarYear << 9) | (solar.SolarMonth << 5) | solar.SolarDay;
            if (Solar11[index] > data) index--;
            var solar11 = Solar11[index];
            var y = GetBitInt(solar11, 12, 9);
            var m = GetBitInt(solar11, 4, 5);
            var d = GetBitInt(solar11, 5, 0);
