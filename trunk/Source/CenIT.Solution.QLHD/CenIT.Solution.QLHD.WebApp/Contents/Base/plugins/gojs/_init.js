function init(diagramEle, toolsEle) {
    // For details, see https://gojs.net/latest/intro/buildingObjects.html
    const $ = go.GraphObject.make; // for conciseness in defining templates

    myDiagram = new go.Diagram(diagramEle, // must name or refer to the DIV HTML element
        {
    ...
    myPalette = new go.Palette(toolsEle, // must name or refer to the DIV HTML element
        {
