...
test("format using constants",
    function(assert) {
        ...
        assert.equal(m.format(moment.HTML5_FMT.DATETIME_LOCAL_SECONDS),
            "2017-09-01T23:40:40",
            "datetime local format constant");
        assert.equal(m.format(moment.HTML5_FMT.DATETIME_LOCAL_MS),
        ...
        assert.equal(m.format(moment.HTML5_FMT.TIME_MS),
            "23:40:40.678",
...
test("toISOString without UTC conversion",
    function(assert) {
        ...
        assert.equal(date.toISOString(true),
...
test("quarter ordinal formats",
    function(assert) {
        ...
        assert.equal(moment([2000, 0, 2]).format("Qo [quarter] YYYY"),
            "1st quarter 2000",
