$(function() {
    ...
    QUnit.test("shoud add toast message",
        function(assert) {
            assert.expect(6);
    ...
    QUnit.test("should add toast message based on existing HTML element",
        function(assert) {
            assert.expect(2);
    ...
    QUnit.test("should remove toast by selector",
        function(assert) {
            assert.expect(1);
    ...
    QUnit.test("should remove toasts by position",
        function(assert) {
            assert.expect(2);
            var done = assert.async();
    ...
    QUnit.test("should prevent adding toaster",
        function(assert) {
            assert.expect(2);
    ...
    QUnit.test('should prevent removing toast messages when they are in "top-right" position',
        function(assert) {
            assert.expect(2);
            var done = assert.async();
    ...
    QUnit.test("should return toaster version",
        function(assert) {
            assert.expect(1);
