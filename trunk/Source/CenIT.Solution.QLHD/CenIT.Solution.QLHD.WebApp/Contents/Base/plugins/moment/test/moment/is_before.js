...
test("is before year",
    function(assert) {
        ...
        assert.equal(m.isBefore(moment(new Date(2010, 11, 31, 23, 59, 59, 999)), "year"),
            false,
...
test("is before minute",
    function(assert) {
        ...
        assert.equal(m.isBefore(moment(new Date(2011, 3, 2, 3, 3, 59, 999)), "minute"),
            false,
...
test("is before millisecond",
    function(assert) {
        ...
        assert.equal(m.isBefore(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), "milliseconds"),
            false,
            "plural should work");
        ...
        assert.equal(m.isBefore(moment(new Date(2011, 3, 2, 3, 4, 6, 11)), "millisecond"),
            true,
