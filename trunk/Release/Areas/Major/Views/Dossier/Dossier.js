        ...
        "ajax":
        {
            ...
            "data": {
                ...
                "DossierStatus": function () {
                    return $("#Search [name='ListDossierStatusIds']:checked").val() != null &&
                        $("#Search [name='ListDossierStatusIds']:checked").val().length > 0
                        ? $.map($("#Search [name='ListDossierStatusIds']:checked"), function (n, i) { return n.value }).join(",")
                        : "";
                },
                "HandleTypes": function () {
                    return $("#Search [name='ListHandleTypeIds']:checked").val() != null &&
                        $("#Search [name='ListHandleTypeIds']:checked").val().length > 0
                        ? $.map($("#Search [name='ListHandleTypeIds']:checked"), function (n, i) { return n.value }).join(",")
                        : "";
                },
            }
        },
