jQuery(function($) {
    ...
    for (var p = 0; p < progressData.length; p++) {
        ...
        if (p > 0) {
            ...
            canvas.setAttribute("style", "bottom: 0; margin-bottom:auto;  margin-top: auto; top: 0;");
        }
    ...
    //flot charts
    var d1 = [
        [0, 12], [1, 22], [2, 24], [3, 20], [4, 25], [5, 15], [6, 24], [7, 23], [8, 16], [9, 16], [10, 18], [11, 21],
        [12, null]
    ];
    var d2 = [
        [0, 40], [1, 48], [2, 35], [3, 30], [4, 40], [5, 39], [6, 40], [7, 41], [8, 36], [9, 37], [10, 42], [11, 52],
        [12, null]
    ];
    var d3 = [
        [0, 2], [1, 2], [2, 1], [3, 1], [4, 1], [5, 2], [6, 1], [7, 1], [8, 1], [9, 2], [10, 2], [11, 1], [12, null]
    ];
