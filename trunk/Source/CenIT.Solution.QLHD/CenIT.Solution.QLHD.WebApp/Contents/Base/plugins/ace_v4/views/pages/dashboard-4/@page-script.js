jQuery(function($) {
    ...
    $(document.getElementById("piechart1").parentNode)
        .after("<div class='piechart-legends mt-1'>" + trafficPieChart.generateLegend() + "</div>");
    ...
    $(document.getElementById("piechart2").parentNode)
        .after("<div class='piechart-legends mt-1'>" + devicePieChart.generateLegend() + "</div>");
            ...
            data: {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        borderColor: ("MozAppearance" in document.documentElement.style)
                            ? "rgba(0, 0, 0, 0.15)"
                            : "rgba(0, 0, 0, 0.05)",
                        borderWidth: 1,
