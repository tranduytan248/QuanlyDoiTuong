jQuery(function($) {
    ...
    for (var containerId in containers) {
        ...
        for (var i = 0; i < cards.length; i++) {
            ...
            if (card) {
                ...
                card.classList
                    .add("mb-3"); //if it's not the first card in this container, maybe add some distance from top 'mt-3'
            }
        } //for
        ...
        Sortable.create(this,
            {
                ...
                draggable:
                    "> .card", // we are interested in dragging/sorting `.card` elements that are direct children of `.cards-container` elements
                animation: 200,
                ...
                handle: (
                    "ontouchstart" in window ? ".card-header" : null), // in touch devices only drag using .card-header
    ...
    AceApp.EventHandler.on(document,
        "hidden.ace.card",
        ".card",
        function(ev) {
