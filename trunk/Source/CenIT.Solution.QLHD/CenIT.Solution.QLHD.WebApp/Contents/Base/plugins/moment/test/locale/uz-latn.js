...
test("parse",
    function(assert) {
        var tests =
                "Yanvar Yan_Fevral Fev_Mart Mar_Aprel Apr_May May_Iyun Iyun_Iyul Iyul_Avgust Avg_Sentabr Sen_Oktabr Okt_Noyabr Noy_Dekabr Dek"
                    .split("_"),
            i;
...
test("format week",
    function(assert) {
        var expected =
                "Yakshanba Yak Ya_Dushanba Dush Du_Seshanba Sesh Se_Chorshanba Chor Cho_Payshanba Pay Pa_Juma Jum Ju_Shanba Shan Sha"
                    .split("_"),
            i;
        for (i = 0; i < expected.length; i++) {
