...
test("parse",
    function(assert) {
        var i,
            tests =
                "Janer Jan._Febrer Feb._Mars Mars_Abril Abr._Mai Mai_Jun Jun_Julai Jul._Agost Ago._Setembr Set._Otubr Otu._Novembr Nov._Dezembr Dez."
                    .split("_");
...
test("format week",
    function(assert) {
        var i,
            expected =
                "Aitar Ait. Ai_Somar Som. Sm_Mongllar Mon. Mo_Budvar Bud. Bu_Brestar Bre. Br_Sukrar Suk. Su_Son'var Son. Sn"
                    .split("_");
