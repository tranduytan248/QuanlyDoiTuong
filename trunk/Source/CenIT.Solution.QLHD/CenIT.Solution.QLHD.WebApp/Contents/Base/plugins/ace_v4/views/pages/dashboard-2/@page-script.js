jQuery(function($) {
    ...
    conversations.addEventListener("expanded.ace.card",
        function() {
    ...
    conversations.addEventListener("restore.ace.card",
        function() {
                        ...
                        custom: function(tooltipModel) {
                            ...
                            $(canvas)
                                ...
                                .on("hidden.bs.tooltip",
                                    function() {
                                        canvas.setAttribute("data-original-title",
                                            ""); //so that when mouse is back over canvas's blank area, no tooltip is shown
                                    });
    ...
    // place legends
    $(trafficSourceCanvas).parent()
        .after("<div id='traffic-source-legends' class='piechart-legends text-95 text-secondary-d3'>" +
            trafficSourcePieChart.generateLegend() +
            "</div>");

    var trafficSourceChart_Legends_Wrapped = document.getElementById("traffic-source-legends").offsetTop >
        trafficSourceCanvas.offsetTop + trafficSourceCanvas.offsetHeight;
    ...
    // place legends
    $(document.getElementById("user-device-chart")).parent().after(
