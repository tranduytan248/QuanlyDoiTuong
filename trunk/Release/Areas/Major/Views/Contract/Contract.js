            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    if (type == "display") {
                        ...
                        var receivedOn = row["ReceivedOn"]; //Ngày tiếp nhận
                        ...
                        var handleOnHtml = liTemplate.format("Ngày tiếp nhận:", moment(receivedOn).format("DD/MM/YYYY HH:mm:ss"), "text-600 text-success-d1 text-105");
                        html += handleOnHtml;
                                ...
                                if (row.IsPaid) {
                                    ...
                                    if (row.HasInv) {
                                        html += _renderButton(true,
                                            ...
                                            '<i class="fas fa-eye text-120"></i> Xem hoá đơn',
                                            "Xem hoá đơn", "1024px");
                                    }
                                    if (row.Status != 4) {
                                        html += _renderButton(true,
