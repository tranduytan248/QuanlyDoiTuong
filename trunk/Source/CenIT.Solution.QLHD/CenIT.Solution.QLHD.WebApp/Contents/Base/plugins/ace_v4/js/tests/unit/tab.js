$(function() {
    ...
    QUnit.test("should scroll tab buttons",
        function(assert) {
            assert.expect(1);
    ...
    QUnit.test("should swipe tab",
        function(assert) {
            ...
            var tabContent =
                $(
                        '<div class="tab-content tab-sliding"><div class="tab-pane active show"></div><div class="tab-pane"></div><div class="tab-pane"></div></div>')
    ...
    QUnit.test("should swipe tabs only in specified direction (right)",
        function(assert) {
            assert.expect(4);
            var done = assert.async();
            viewport.set(320, 480);
        ...
        <div class="tab-pane"></div>
            ...
            setTimeout(function() {
                    ...
                    setTimeout(function() {
                            ...
                            assert.ok(tabPane.previousElementSibling.matches(".show.active"),
                                "active page has changed");
    ...
    QUnit.test("should swipe next to specified target",
        function(assert) {
            assert.expect(3);
            var done = assert.async();
            viewport.set(320, 480);
    ...
    QUnit.test("should swipe prev to specified target",
        function(assert) {
            assert.expect(3);
            var done = assert.async();
            viewport.set(320, 480);
