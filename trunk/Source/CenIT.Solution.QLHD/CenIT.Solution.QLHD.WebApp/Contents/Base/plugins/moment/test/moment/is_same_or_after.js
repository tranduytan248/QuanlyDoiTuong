...
test("is same or after day",
    function(assert) {
        ...
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 1, 23, 59, 59, 999)), "day"),
            true,
            "end of previous day");
...
test("is same or after minute",
    function(assert) {
        ...
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 2, 3, 4, 0, 0)), "minute"),
            true,
            "exact start of minute");
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 2, 3, 4, 59, 999)), "minute"),
            true,
            "exact end of minute");
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 2, 3, 5, 0, 0)), "minute"),
            false,
...
test("is same or after second",
    function(assert) {
        ...
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 2, 3, 4, 5, 0)), "second"),
            true,
            "exact start of second");
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 2, 3, 4, 5, 999)), "second"),
            true,
            "exact end of second");
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 1, 2, 3, 4, 6, 0)), "second"),
            false,
...
test("is same or after millisecond",
    function(assert) {
        ...
        assert.equal(m.isSameOrAfter(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), "millisecond"),
            true,
            "year is earlier");
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 4, 2, 3, 4, 5, 10)), "millisecond"),
            false,
            "month is later");
        ...
        assert.equal(m.isSameOrAfter(moment(new Date(2011, 3, 1, 4, 1, 5, 10)), "millisecond"),
            true,
            "hour is earlier");
...
test("is same or after with utc offset moments",
    function(assert) {
        assert.ok(moment.parseZone("2013-02-01T00:00:00-05:00").isSameOrAfter(moment("2013-02-01"), "year"),
        ...
        assert.ok(moment.parseZone("2013-02-01T00:00:00-05:00")
            .isSameOrAfter(moment.parseZone("2013-02-01T00:00:00-06:30"), "year"),
