...
namespace Reports._05.ThongKeHoSoHoanThanh
{
    public class _05ThongKeHoSoHoanThanh : IReport
    {
        private string TemplateReport => "_05ThongKeHoSoHoanThanh.rdlc";
        private object[] ReportParams { get; set; }
        private string DataSetName => "ThongKeHoSoHoanThanh05";
        public string ReportKey => "_05ThongKeHoSoHoanThanh";
        public string ReportName => "05 - Thống kê hồ sơ đã hoàn thành";
        public string Description => "05 - Thống kê hồ sơ đã hoàn thành";
        public string ProcedureName => "p_Reports_05ThongKeHopDongDaHoanThanh";
        public string ViewName => "_05ThongKeHoSoHoanThanh";
